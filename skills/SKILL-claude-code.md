...
### `/plot apply`
**IMPORTANT:** Suivre cette logique exacte:
...
5. **Proposer les modifications** à l'utilisateur

6. **Appliquer après confirmation**

7. **Régénérer** si `regen_cmd` disponible
...
Claude: J'ai lu 2 groupes d'annotations:

**Groupe 2 (bleu):**
- Rectangle sur légende (2491, 1146) → (3054, 1301)
- Instruction: "Dynamic → Updated"
- → Modifier le label "Dynamic (Sentinel-2)" en "Updated (Sentinel-2)"

**Groupe 3 (rouge):**
- Rectangle sur x-axis labels (197, 1283) → (2299, 1487)
- Instruction: "smaller font"
- → Ajouter `ax.tick_params(axis='x', labelsize=8)`

Je modifie le fichier scripts/plot_trends.py...
[Modifications appliquées]

Régénération du plot...
[Commande exécutée]

Nouveau plot sauvegardé. Voici le résultat:
